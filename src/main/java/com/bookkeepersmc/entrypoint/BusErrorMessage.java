...
import com.bookkeepersmc.entrypoint.api.Event;
...
public class BusErrorMessage implements Message, StringBuilderFormattable {
    //private final Event event;
    private final int index;
    private final EventListener[] listeners;
    private final Throwable throwable;

    public BusErrorMessage(final Event event, final int index, final EventListener[] listeners, final Throwable throwable) {
        //this.event = event;
        this.index = index;
